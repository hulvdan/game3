...
func set_status(status: int) -> void:
	match status:
		BeehaveNode.SUCCESS:
			_set_stylebox_overrides(frames.panel_success, frames.titlebar_success)
		BeehaveNode.FAILURE:
			_set_stylebox_overrides(frames.panel_failure, frames.titlebar_failure)
		BeehaveNode.RUNNING:
			_set_stylebox_overrides(frames.panel_running, frames.titlebar_running)
		_:
			_set_stylebox_overrides(frames.panel_normal, frames.titlebar_normal)
